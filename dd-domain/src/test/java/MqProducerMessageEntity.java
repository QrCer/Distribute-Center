 ...
 */
@Entity
@Table(name = "MQ_PRODUCER_MESSAGE")
public class MqProducerMessageEntity {
    private Integer id;
    ...
    private Serializable deleteTime;
    ...
    @Column(name = "BODY", nullable = true, columnDefinition = "mediumtext")
    ...
    @Basic
    @Column(name = "DELETE_TIME", nullable = true, columnDefinition = "Datetime")
    public Serializable getDeleteTime() {
        return deleteTime;
    }

    public void setDeleteTime(Serializable deleteTime) {
        this.deleteTime = deleteTime;
    }

    @Basic(fetch = FetchType.LAZY)
    @Column(name = "RAW_MESSAGE", nullable = true, columnDefinition = "mediumtext")
    ...
    public boolean equals(Object o) {
        ...
        MqProducerMessageEntity that = (MqProducerMessageEntity) o;
